 ...
 */
final class Version20230407102901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reactions ADD user_id VARCHAR(255) NOT NULL, ADD post_id VARCHAR(255) NOT NULL, DROP post_id_id, DROP user_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON reactions');
        $this->addSql('ALTER TABLE reactions ADD post_id_id INT NOT NULL, ADD user_id_id INT NOT NULL, DROP user_id, DROP post_id');
